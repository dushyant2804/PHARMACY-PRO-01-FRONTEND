...
export const ledgerShareMessage = ({ type, entity = {}, balance = 0, transactions = [] }) => [
  ...
  type === "customer" ? "This is a polite reminder regarding your account statement." : "Please find a summary of our payable account statement.",
  `Current ${type === "customer" ? "balance due" : "payable balance"}: ${fmtINR(balance)}`,
